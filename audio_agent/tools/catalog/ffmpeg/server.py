...
class FFmpegMCPServer:
    ...
    def _get_tools_list(self) -> list[dict[str, Any]]:
        ...
        return [
            ...
            {"name": "resample_audio", "description": "Resample to target rate", "inputSchema": {"type": "object", "properties": {"audio_path": {"type": "string"}, "output_path": {"type": "string"}, "sample_rate": {"type": "integer", "default": 22050}}, "required": ["audio_path"]}},
