...
class FFmpegMCPServer:
    ...
    def _get_tools_list(self) -> list[dict[str, Any]]:
        ...
        return [
            ...
            # PHASE 3: EQ (8)
            {"name": "highpass_filter", "description": "Apply a high-pass filter to remove low-frequency content such as rumble or handling noise. Useful for preprocessing, not semantic analysis.", "inputSchema": {"type": "object", "properties": {"audio_path": {"type": "string"}, "output_path": {"type": "string"}, "frequency": {"type": "number", "default": 80}, "poles": {"type": "integer", "default": 2}}, "required": ["audio_path"]}},
            {"name": "lowpass_filter", "description": "Apply a low-pass filter to remove high-frequency content such as hiss. Useful for preprocessing, not semantic analysis.", "inputSchema": {"type": "object", "properties": {"audio_path": {"type": "string"}, "output_path": {"type": "string"}, "frequency": {"type": "number", "default": 8000}, "poles": {"type": "integer", "default": 2}}, "required": ["audio_path"]}},
            {"name": "bandpass_filter", "description": "Apply a band-pass filter to isolate a frequency range. Useful for creating derived audio for downstream inspection, not content analysis by itself.", "inputSchema": {"type": "object", "properties": {"audio_path": {"type": "string"}, "output_path": {"type": "string"}, "frequency": {"type": "number", "default": 1000}, "width": {"type": "number", "default": 200}}, "required": ["audio_path"]}},
            {"name": "bandreject_filter", "description": "Apply a notch / band-reject filter to suppress a frequency range such as hum. Useful for preprocessing, not content analysis.", "inputSchema": {"type": "object", "properties": {"audio_path": {"type": "string"}, "output_path": {"type": "string"}, "frequency": {"type": "number", "default": 50}, "width": {"type": "number", "default": 20}}, "required": ["audio_path"]}},
            ...
            {"name": "silenceremove", "description": "Remove silence sections automatically using threshold-based detection. Useful for cleanup, but the thresholds are heuristic and not semantic.", "inputSchema": {"type": "object", "properties": {"audio_path": {"type": "string"}, "output_path": {"type": "string"}, "noise_db": {"type": "number", "default": -50}, "min_silence_duration": {"type": "number", "default": 0.5}}, "required": ["audio_path"]}},
            ...
            {"name": "silencedetect", "description": "Detect likely silence periods using threshold-based analysis. Useful for rough structure finding, not semantic segmentation.", "inputSchema": {"type": "object", "properties": {"audio_path": {"type": "string"}, "noise_db": {"type": "number", "default": -50}, "min_duration": {"type": "number", "default": 0.5}}, "required": ["audio_path"]}},
