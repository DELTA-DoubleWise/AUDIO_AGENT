...
class FFmpegMCPServer:
    ...
    def _get_tools_list(self) -> list[dict[str, Any]]:
        ...
        return [
            ...
            {"name": "resample_audio", "description": "Resample audio to a specific sample rate. REQUIRED parameter: 'sample_rate' (e.g., 16000, 22050, 44100). Optional: 'output_path'.", "inputSchema": {"type": "object", "properties": {"audio_path": {"type": "string", "description": "Path to input audio file"}, "sample_rate": {"type": "integer", "description": "Target sample rate in Hz. Use 16000 for most ML models, 22050 or 44100 for high quality. REQUIRED."}, "output_path": {"type": "string", "description": "Optional output path. If not provided, saved to temp directory."}}, "required": ["audio_path", "sample_rate"]}},
