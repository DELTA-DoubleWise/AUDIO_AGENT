#!/usr/bin/env python3
"""
Run MMAU Benchmark with Gemini 2.5 Pro Frontend — Parallel Worker Version.
...
Usage:
    ...
    python -m benchmarking.mmau.run_gemini_parallel --num-samples 1000

    # More workers for faster execution
    python -m benchmarking.mmau.run_gemini_parallel --num-samples 1000 --workers 8

    # Resume from previous run
    python -m benchmarking.mmau.run_gemini_parallel --num-samples 1000 \
        --output-dir ./test_result/mmau_gemini_full
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Run MMAU Benchmark with Gemini 2.5 Pro Frontend (Parallel)",
...
Examples:
    ...
    parser.add_argument(
        "--dataset-dir",
        type=str,
        default="/cpfs/user/jingpeng/workspace/nfs/data/test/MMAU",
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="/cpfs/user/jingpeng/workspace/AUDIO_AGENT/test_result/mmau_gemini_full",
...
async def run_worker(
    ...
    try:
        ...
        save_metrics_report(
            metrics,
            str(paths["report"]),
            title=f"MMAU Benchmark Results - Worker {worker_id}\n"
...
def run_benchmark(args: argparse.Namespace):
    ...
    print("=" * 70)
    print("  MMAU Benchmark - Gemini 2.5 Pro Frontend (Parallel)")
    print("=" * 70)
