#!/usr/bin/env python3
"""
Run MMAR Benchmark with Gemini 2.5 Pro Frontend — Multi-GPU Parallel Worker Version.
...
Usage:
    ...
    python -m benchmarking.mmar.run_gemini_parallel_multigpu --num-samples 1000 --workers 4 --gpus 2

    # 8 workers across 2 GPUs
    python -m benchmarking.mmar.run_gemini_parallel_multigpu --num-samples 1000 --workers 8 --gpus 2

    # Single GPU
    python -m benchmarking.mmar.run_gemini_parallel_multigpu --num-samples 1000 --workers 4 --gpus 1
"""
...
from benchmarking.mmar.run_gemini_parallel import (
...
def run_benchmark(args: argparse.Namespace):
    ...
    print("=" * 70)
    print("  MMAR Benchmark - Gemini 2.5 Pro Frontend (Multi-GPU Parallel)")
    print("=" * 70)
