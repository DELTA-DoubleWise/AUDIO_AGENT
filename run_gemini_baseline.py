...
Examples:
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="/cpfs/user/jingpeng/workspace/AUDIO_AGENT/test_result/gemini_baseline",
